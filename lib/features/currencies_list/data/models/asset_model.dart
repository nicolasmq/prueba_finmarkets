...
class AssetModel extends AssetEntity {
  ...
  factory AssetModel.fromMap(Map<String, dynamic> json) => AssetModel(
        ...
        dataQuoteStart: json["data_quote_start"] == null
            ? null
            : DateTime.parse(json["data_quote_start"]),
        dataQuoteEnd: json["data_quote_end"] == null
            ? null
            : DateTime.parse(json["data_quote_end"]),
        dataOrderbookStart: json["data_orderbook_start"] == null
            ? null
            : DateTime.parse(json["data_orderbook_start"]),
        dataOrderbookEnd: json["data_orderbook_end"] == null
            ? null
            : DateTime.parse(json["data_orderbook_end"]),
        dataTradeStart: json["data_trade_start"] == null
            ? null
            : DateTime.parse(json["data_trade_start"]),
        dataTradeEnd: json["data_trade_end"] == null
            ? null
            : DateTime.parse(json["data_trade_end"]),
        ...
        dataStart: json["data_start"] == null
            ? null
            : DateTime.parse(json["data_start"]),
        dataEnd:
            json["data_end"] == null ? null : DateTime.parse(json["data_end"]),
      );
...
class AssetIconModel extends AssetIcon {
  const AssetIconModel({String? assetId, String? url})
      : super(assetId: assetId, url: url);

  factory AssetIconModel.fromJson(String str) =>
      AssetIconModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AssetIconModel.fromMap(Map<String, dynamic> json) => AssetIconModel(
        assetId: json["asset_id"],
        url: json["url"],
      );
  ...
  AssetIcon toAssetIcon() => AssetIcon(assetId: assetId, url: url);
}
